 ...
 * and returns a chosen delimitted file containing only column 
            ...
            if(tokens.hasNext()){	
                ...
                for(int i = 0; i < info.length; i++){
                    ...
                    if(infoColumnA.contains(bothParts[0])){
                        ...
                        if(bothParts[0].matches("^.*_AF") || bothParts[0].matches("^AF")){
    ...
    public static void buildColumnHeaders(Scanner input){
        ...
        while(input.hasNextLine()){
            ...
            if (line.matches("^##INFO.*")){
                ...
                if(columnName.matches("^.*_AF") || columnName.matches("^AF")){
            ...
            if (line.matches("^#CHROM.*")){
                ...
                if (howManyFound == 0) {
                    System.err.println("Sorry no fields matching AF or <pop>_AF were found.");
                    System.exit(1);
                }
                printKey();
