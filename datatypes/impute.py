...
class Gtool(ImputeDatatypes):
    ...
    def __init__(self, **kwd):
        ...
        self.add_composite_file('%s.gen',description= " Gtool Genotypes File", substitute_name_with_metadata='base_name', is_binary=False)
        self.add_composite_file('%s.sample', description= " Gtool Sample File", substitute_name_with_metadata="base_name", is_binary=False)
