...
#phase using shapit
#pop1
shapeit.v2.r644.linux.x86_64 --input-ped pop1_missing_removed.ped pop2_missing_removed.map -M "${shapeit_dir}/genetic_maps_b37/genetic_map_chr${2}_combined_b37.txt" --output-max pop1.phased --thread 6
#pop2
shapeit.v2.r644.linux.x86_64 --input-ped pop2_missing_removed.ped pop2_missing_removed.map -M "${shapeit_dir}/genetic_maps_b37/genetic_map_chr${2}_combined_b37.txt" --output-max pop2.phased --thread 6
echo point 7
